...
"Lets-build-websites-again.md": {
	id: "Lets-build-websites-again.md";
  slug: "lets-build-websites-again";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
"Lets-play-ball.md": {
	id: "Lets-play-ball.md";
  slug: "lets-play-ball";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
"React-Miami-2026-Write-up.md": {
	id: "React-Miami-2026-Write-up.md";
  slug: "react-miami-2026-write-up";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
"Ready-for-new-opportunities.md": {
	id: "Ready-for-new-opportunities.md";
  slug: "ready-for-new-opportunities";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
...
"The-newest-trend-in-design-will-be-words.md": {
	id: "The-newest-trend-in-design-will-be-words.md";
  slug: "the-newest-trend-in-design-will-be-words";
  body: string;
  collection: "posts";
  data: InferEntrySchema<"posts">
} & { render(): Render[".md"] };
